...
export default function Footer() {
  ...
  return (
    <>
      <div className="border-accent-foreground mx-auto max-w-6xl border-dotted px-4 md:border-x md:px-6">
        <div className="border-muted-foreground h-6 border-x border-t border-dotted" />
      </div>
      <div className="border-accent-foreground mx-auto max-w-6xl border-t border-dotted px-2 md:border-x md:px-6">
